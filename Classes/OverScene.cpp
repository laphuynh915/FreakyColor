...
bool OverScene::init()
{
	...
	//Button
	auto menuBtn = MenuItemImage::create("MenuBtn.png", "MenuBtnSelected.png", CC_CALLBACK_0(OverScene::gotoMenuScene, this));
	auto replayBtn = MenuItemImage::create("AgainBtn.png", "AgainBtnSelected.png", CC_CALLBACK_0(OverScene::gotoPlayScene, this));
	menuBtn->setScale(0.5);
	replayBtn->setScale(0.75);
